            ...
            <div class="modal-content">
                <form wire:submit.prevent="guardar">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary pb-2" wire:click="$set('showModal', false)">Cancelar</button>
                        <button type="submit" class="btn btn-primary pb-2">Guardar</button>
                    </div>
                </form>
            </div>
        </div>
